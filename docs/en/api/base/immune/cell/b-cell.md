...
| `feature_type` | `{ "binary-features", "continuous-features", "ranged-features" }` | `"continuous-features"` | Specifies the type of feature_type to use based on the nature of the input features |
