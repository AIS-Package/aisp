...
@pytest.mark.parametrize(
    ...
    ids=[
        "Distância de Hamming entre vetores binários diferentes Inteiros",
        "Distância de Hamming entre vetores binários diferentes Boleanos",
    ]
)
def test_hamming(u, v, expected_output):
    """Teste para distância de Hamming"""
    result = hamming(u, v)
    assert result == expected_output
...
def test_cityblock(u, v, expected_output):
    """Teste para distância Cityblock (Manhattan)"""
